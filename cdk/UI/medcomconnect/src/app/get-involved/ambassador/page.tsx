  ...
  return (
    <main className="min-h-screen bg-[var(--warm-bg)]">
      <PageHero
        ...
        title="Help new people feel that they belong here."
        description="Ambassadors help people find their way into the network. They welcome new members, share accurate information, connect local communities and bring back ideas that improve the member experience."
      />

      <div className="flex flex-col">
        <SectionLayout badge="01 — WHAT AMBASSADORS DO" title="What ambassadors do" bg="white">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
            <motion.div initial={{opacity:0, y:30}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:0.6, delay: 0}} className="col-span-12 md:col-span-6 lg:col-span-4 relative group flex flex-col h-full text-left bg-white rounded-[24px] p-8 shadow-[0_4px_20px_rgba(15,41,66,0.04)] border border-[var(--cream-dark)] hover:-translate-y-[6px] transition-all duration-300">
              ...
              <h3 className="text-xl font-display text-[var(--brown-dark)] mb-3">What ambassadors do</h3>
              <p className="text-[var(--text-muted)] leading-relaxed text-[0.95rem] mb-8 flex-grow relative z-10 max-w-[700px]">
                What ambassadors do should make the next professional choice easier. Explore the available options, understand what each one is designed for and choose the route that best fits the work you are doing now.
              </p>
        ...
        <SectionLayout badge="02 — WHO IT SUITS" title="Who it suits" bg="alternate">
            ...
            <motion.div initial={{opacity:0, y:30}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:0.6, delay: 0}} className="flex items-start gap-6 md:gap-8 py-10 border-b border-[var(--cream-dark)] last:border-0">
              ...
              <div className="flex flex-col gap-3 md:gap-4 flex-grow">
                <p className="text-[var(--text-muted)] text-[1.05rem] md:text-[1.1rem] leading-relaxed max-w-[700px]">
                  Who it suits should make the next professional choice easier. Explore the available options, understand what each one is designed for and choose the route that best fits the work you are doing now.
                </p>
                <div className="mt-4">
                  <div className="btn-secondary text-sm w-max inline-flex items-center group cursor-pointer">
                    Find a way to contribute <ChevronRight size={16} className="transition-transform group-hover:translate-x-1" />
        ...
        <SectionLayout badge="04 — MEET AMBASSADORS" title="Meet ambassadors" bg="alternate">
          <div className="flex flex-col max-w-4xl mx-auto">
            <motion.div initial={{opacity:0, y:30}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:0.6, delay: 0}} className="flex items-start gap-6 md:gap-8 py-10 border-b border-[var(--cream-dark)] last:border-0">
              <div className="w-12 h-12 rounded-full bg-[var(--teal)] text-white flex items-center justify-center flex-shrink-0 font-display text-xl">
                1
              ...
              <div className="flex flex-col gap-3 md:gap-4 flex-grow">
                <p className="text-[var(--text-muted)] text-[1.05rem] md:text-[1.1rem] leading-relaxed max-w-[700px]">
                  Meet ambassadors should make the next professional choice easier. Explore the available options, understand what each one is designed for and choose the route that best fits the work you are doing now.
                </p>
                <div className="mt-4">
                  <div className="btn-secondary text-sm w-max inline-flex items-center group cursor-pointer">
                    Find a way to contribute <ChevronRight size={16} className="transition-transform group-hover:translate-x-1" />
